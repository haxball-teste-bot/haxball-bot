...
export function cmdHelp(room, player) {
  const lines = [
    ...
    { text: '  !saldo          — Ver suas Coins', color: 0xDCDCDC, style: 'normal' },
    { text: '  !addcoins <v>   — Adicionar Coins (Admin)', color: 0xDCDCDC, style: 'normal' },
    ...
    { text: '🎒 Inventário:', color: 0xF0E68C, style: 'normal' },
    { text: '  !itens          — Ver seu inventário e VIP', color: 0xDCDCDC, style: 'normal' },
    ...
    { text: '📊 Estatísticas:', color: 0xF0E68C, style: 'normal' },
    { text: '  !status [nick]  — Ver estatísticas de um jogador', color: 0xDCDCDC, style: 'normal' },
    { text: '  !top            — Ver ranking Top 10', color: 0xDCDCDC, style: 'normal' },
    { text: '  !streak         — Ver sequência de vitórias atual', color: 0xDCDCDC, style: 'normal' },
    { text: '🚫 Punição:', color: 0xF0E68C, style: 'normal' },
    { text: '  !tempban <n> <m>— Banir por 15 min (5.000 Coins)', color: 0xDCDCDC, style: 'normal' },
